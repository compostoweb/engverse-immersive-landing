        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div className="text-center md:text-left">
            ...
            <p className="text-lg md:text-xl text-gray-200 mb-8 max-w-lg mx-auto md:mx-0">
              Soluções de AR, VR e Realidade Mista que elevam segurança, produtividade e precisão em projetos de engenharia.
            </p>
          ...
          <div className={cn(
            ...
            "before:absolute before:inset-0 before:bg-gradient-to-r before:from-engverse-blue/30 before:to-engverse-purple/30 before:rounded-lg before:z-10",
            "after:absolute after:w-40 after:h-40 after:bg-engverse-purple/20 after:rounded-full after:blur-3xl after:top-1/4 after:-right-20 after:z-0"
          )}>
            <div className="relative z-20 animate-float">
              <div className="bg-white/10 backdrop-blur-sm p-2 rounded-lg border border-white/20 mb-4">
                <div className="grid grid-cols-2 gap-2">
                  {[1, 2].map(index => (
                    <div key={index} className="aspect-video bg-gradient-to-br from-engverse-blue/30 to-engverse-purple/30 rounded-md flex items-center justify-center">
                      <div className="w-full h-full flex items-center justify-center">
                        <div className="rounded-md bg-white/20 w-10 h-10 flex items-center justify-center">
                    ...
                    <div className="grid grid-cols-3 gap-3 p-4 w-full">
                      {[...Array(9)].map((_, index) => (
                        <div 
                          key={index} 
                          className={cn(
                            "h-12 rounded-md bg-white/10",
                            index % 3 === 0 && "bg-engverse-blue/30",
                            index % 4 === 0 && "bg-engverse-purple/30"
                          )}
                        />
                      ))}
                    </div>
