        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-16 pb-16">
          ...
          <div className="flex-1 text-center lg:text-left max-w-2xl mx-auto lg:mx-0">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-8 leading-tight">
              Transforme sua <span className="bg-clip-text text-transparent bg-gradient-to-r from-engverse-orange via-engverse-blue to-engverse-orange">engenharia</span> com tecnologias imersivas
            </h1>
