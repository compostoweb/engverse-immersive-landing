            ...
            <div className="p-8 md:p-12">
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input 
                      ...
                      className="w-full bg-white/10 border border-white/10 rounded-lg px-4 py-2.5 text-white placeholder:text-gray-500 focus:border-engverse-blue/50 focus:outline-none focus:ring-1 focus:ring-engverse-blue/50"
                ...
                <button 
                  ...
                  className={cn(
                    "flex items-center justify-center gap-2 w-full px-6 py-3 bg-gradient-to-r from-engverse-orange to-engverse-blue rounded-lg text-white font-medium hover:shadow-lg transition-all",
