      ...
      <div className="container mx-auto px-4 my-[15px]">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-1">
            {["Serviços", "Diferenciais", "Setores"].map(item => <a key={item} href={`#${item === 'Segmentos' ? 'clientes' : item.toLowerCase()}`} className="px-4 py-2 text-gray-300 hover:text-white transition-colors">
                {item}
              </a>)}
