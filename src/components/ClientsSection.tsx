...
const ClientsSection = () => {
  ...
  const benefits = [
    "Integração direta com sistemas de gestão existentes",
    "Equipe técnica multidisciplinar especializada",
    "Suporte 24/7 para questões críticas",
    "Customização completa para seus fluxos de trabalho",
  ];

  return (
    <section id="clientes" className="py-24 bg-[#0F172A]">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-6 mb-20">
          {clientTypes.map((client, index) => (
            <div key={index} className="bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 p-5 hover:border-white/20 hover:bg-white/10 transition-all text-center cursor-pointer">
