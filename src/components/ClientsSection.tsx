...
const ClientsSection = () => {
  ...
  const benefits = ["Integração direta com sistemas de gestão existentes", "Equipe técnica multidisciplinar especializada", "Suporte 24/7 para questões críticas", "Customização completa para seus fluxos de trabalho"];
