...
const ClientsSection = () => {
  const clientTypes = [{
    ...
    icon: <span className="inline-flex items-center justify-center bg-orange-500 p-1 rounded-full"><svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
