...
const Footer = () => {
  return (
    <footer className="bg-engverse-dark text-white pt-12 pb-6">
            ...
            <div className="flex space-x-4">
              {["linkedin", "twitter", "facebook", "instagram"].map((social) => (
                <a 
                  key={social}
                  href="#" 
                  className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-engverse-blue/80 transition duration-300"
                  aria-label={social}
                >
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                ...
                <span className="text-gray-300">contato@engverse.com.br</span>
              </li>
              <li className="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3 text-engverse-blue" fill="none" viewBox="0 0 24 24" stroke="currentColor">
